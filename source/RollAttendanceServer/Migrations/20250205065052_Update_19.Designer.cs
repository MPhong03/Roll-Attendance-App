...
namespace RollAttendanceServer.Migrations
{
    ...
    [Migration("20250205065052_Update_19")]
            ...
            modelBuilder.Entity("RolePermissions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PermissionsId = "9AABD4D868FC4132B08775CBDB4E53EC",
                            RolesId = "AF446BC0F6854E0785AA4048B7223374"
                        });
                });
            ...
            modelBuilder.Entity("RollAttendanceServer.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0A9ABBCE5DFA44A4B649FC9D8EFA27A8",
                            Email = "admin@gmail.com",
                            IsDeleted = false,
                            Password = "$2a$10$JE4pcGOGW1MZMuWu.QnxX.M3dPQIrQyMh8Uj4sATubBY.MB.S32G6",
                            Phone = "0000000000",
                            RoleId = "AF446BC0F6854E0785AA4048B7223374"
                        });
                });
            ...
            modelBuilder.Entity("RollAttendanceServer.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "332ED5BFA46743E392AE9E0B292F89A3",
                            CreatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3643),
                            IsDeleted = false,
                            PermissionName = "Organization Management",
                            PermissionValue = "organization_management",
                            UpdatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3647)
                        },
                        new
                        {
                            Id = "BE14EB29931446658FAD465E03792FB5",
                            CreatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3654),
                            IsDeleted = false,
                            PermissionName = "User Management",
                            PermissionValue = "user_management",
                            UpdatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3654)
                        },
                        new
                        {
                            Id = "9AABD4D868FC4132B08775CBDB4E53EC",
                            CreatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3658),
                            IsDeleted = false,
                            PermissionName = "Administrator",
                            PermissionValue = "all_permissions",
                            UpdatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3659)
                        });
                });
            ...
            modelBuilder.Entity("RollAttendanceServer.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "AF446BC0F6854E0785AA4048B7223374",
                            CreatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3969),
                            IsDeleted = false,
                            RoleName = "Administrator",
                            UpdatedAt = new DateTime(2025, 2, 5, 6, 50, 52, 382, DateTimeKind.Utc).AddTicks(3969)
                        });
                });
