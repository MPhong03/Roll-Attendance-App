...
namespace RollAttendanceServer.Migrations
{
    ...
    [Migration("20241215144316_Update_13")]
            ...
            modelBuilder.Entity("RolePermissions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PermissionsId = "72881CF5D0D347C8B659F3A06DBE7BA5",
                            RolesId = "B70B391820D94EBBBEB44F19C93B32A9"
                        });
                });
            ...
            modelBuilder.Entity("RollAttendanceServer.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "81BA6E331AB54D9A8A42A98A2F199DFF",
                            Email = "admin@gmail.com",
                            IsDeleted = false,
                            Password = "$2a$10$FBl77l9kWuZ45ZH8Aph94eTubbKfTfW0biTi7cuWgaDXYCqnY9rUW",
                            Phone = "0000000000",
                            RoleId = "B70B391820D94EBBBEB44F19C93B32A9"
                        });
                });
            ...
            modelBuilder.Entity("RollAttendanceServer.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "EC94F9A12E8544C29871387BF15B11EE",
                            CreatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1639),
                            IsDeleted = false,
                            PermissionName = "Organization Management",
                            PermissionValue = "organization_management",
                            UpdatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1644)
                        },
                        new
                        {
                            Id = "3F0ED0A111904DAAB2DC5019C54C60AE",
                            CreatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1653),
                            IsDeleted = false,
                            PermissionName = "User Management",
                            PermissionValue = "user_management",
                            UpdatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1653)
                        },
                        new
                        {
                            Id = "72881CF5D0D347C8B659F3A06DBE7BA5",
                            CreatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1661),
                            IsDeleted = false,
                            PermissionName = "Administrator",
                            PermissionValue = "all_permissions",
                            UpdatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1662)
                        });
                });
            ...
            modelBuilder.Entity("RollAttendanceServer.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "B70B391820D94EBBBEB44F19C93B32A9",
                            CreatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1915),
                            IsDeleted = false,
                            RoleName = "Administrator",
                            UpdatedAt = new DateTime(2024, 12, 15, 14, 43, 15, 702, DateTimeKind.Utc).AddTicks(1915)
                        });
                });
