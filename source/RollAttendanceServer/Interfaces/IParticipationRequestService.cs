...
namespace RollAttendanceServer.Interfaces
{
    ...
    {
        Task<PagedResult<ParticipationRequest>> GetParticipationRequestsAsync(string userId, string organizationId, string keyword, int status, int pageIndex, int pageSize);
