...
class OrganizationInviteRequestsScreen extends StatefulWidget {
  final String organizationId;

  const OrganizationInviteRequestsScreen(
      {super.key, required this.organizationId});

  @override
  State<OrganizationInviteRequestsScreen> createState() =>
      _OrganizationInviteRequestsScreenState();
}

class _OrganizationInviteRequestsScreenState
    extends State<OrganizationInviteRequestsScreen> {
  ...
  Future<List<InviteRequestModel>> getRequests() async {
    try {
  ...
  Future<void> _cancelRequest(String requestId) async {
    ...
    try {
      final response = await _apiService
          .put('api/Organization/invite/cancel/$requestId', {});
      if (response.statusCode == 200) {
        if (mounted) {
